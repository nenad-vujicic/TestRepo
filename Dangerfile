...
auto_label.set(pr_number, "Big PR", "FFFD55") if git.lines_of_code > 500
...
unless modified_yaml_files.empty?
  ...
  auto_label.set(pr_number, "Compromised Translations", "F08650")
end

# Report "Everything is fine!" if no warnings were generated
message("Everything is fine!") if github.pr_warnings.empty?
auto_label.set(pr_number, "Good PR", "A1FA4F") if github.pr_warnings.empty?
